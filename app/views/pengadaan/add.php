                        ...
                        <div class="card-body">
                            ...
                            <form role="form" action="<?= URLROOT; ?>/pengadaan/addbahan" method="POST" enctype="multipart/form-data">
                                <div class="row mb-3">
                                  ...
                                  <div class="col-sm-6">
                                    <input type="text" name="nbahan" required class="form-control input-filter" id="inputNama" placeholder="Masukkan nama barang...">
                                  </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-sm-6">
                                    <input type="text" name="jumlah" required class="form-control input-filter" id="inputNama" placeholder="Masukkan jumlah barang...">
                                  </div>
                                </div>
