        ...
        <div class="card-body">
            ...
            <form action="<?= URLROOT; ?>/admin/edit" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                    <input type="text" class="form-control" id="nip" name="nip" value="<?= $data['admin']->nama_admin ?>" readonly>
                    </div>
                </div>
                <h6>Daftar Admin</h6>
                <ul>
                  <?php
                    foreach ($data['pegawai'] as $k) {
                      ...
                      <li><?= $k->nama ?> (<?= $k->nip ?>) <a href="<?= URLROOT; ?>/admin/deleteAdmin/<?php echo $data['admin']->id.'-'.$k->nip ?>">Hapus</a></li>
                      <?php
                    }
                  ?>
                </ul>
            ...
            <div class="form-group row">
                ...
                <a href="<?= URLROOT; ?>/admin" class="btn btn-danger">Kembali</a>
                </div>
            </div>
            </form>
        </div>
