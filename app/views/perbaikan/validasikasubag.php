                ...
                <section class="content">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="<?= URLROOT; ?>/perbaikan/validasikasubag/<?= $data['perbaikan']->serial_number; ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="status" value="Ditolak kasubag" id="status" onchange="showAlasanCatatan()">
