                ...
                <section class="content">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="<?= URLROOT; ?>/surattugas/validasippk/<?= $data['laporan']->id; ?>" method="POST" enctype="multipart/form-data">
                                <div class="row mb-3">
                                </div>
                              ...
                              <div class="mb-3 text-center bg-primary text-white">
                                  <p class="text-center p-2">Form Validasi PPK</p>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="col-sm-6">
                                    <textarea type="text" name="alasan_ditolak"  class="form-control" id="alasan_ditolak" placeholder="Tulis Alasan ditolak..." readonly></textarea>
                                  </div>
                                </div>
