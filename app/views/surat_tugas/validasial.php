                ...
                <section class="content">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="<?= URLROOT; ?>/surattugas/validasial/<?= $data['laporan']->id; ?>" method="POST" enctype="multipart/form-data">
                                <div class="row mb-3">
                                </div>
                              ...
                              <div class="mb-3 text-center bg-primary text-white">
                                  <p class="text-center p-2">Form Validasi Atasan Langsung</p>
                                </div>
                                <div class="row mb-3">
